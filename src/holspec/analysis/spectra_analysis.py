"""
EnsembleSpectraAnalysis class for per-dataset spectral analysis.

Wraps a collection of Spectrum objects organized by (k, component) pairs,
eagerly computes scalar observables, and provides lazy-cached eigenvalue
distribution estimation. The primary factory ``from_file`` reads directly
...
from .distributions import empirical_distribution, _HISTOGRAM_DEFAULTS
