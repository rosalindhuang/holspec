...
class HodgeLaplacian:
    ...
    def save(
        ...
        filepath : str or Path
            Output file path.
        save_laplacians : bool, default=True
            Whether to write cached Laplacian matrices. When False, only
            root-level attributes (max_dim, content_hash, sc_content_hash,
            cm_content_hash, cached_keys, metadata) are written; cached_keys
