"""
Provenance tracing and chain-following loaders for the holspec pipeline.

Provides ``trace_provenance`` for walking the chain of pipeline output
files via root-level HDF5 ``input_file`` attributes, plus loaders that
